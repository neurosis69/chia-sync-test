...
def validate_clvm_and_signature(
    ...
    try:
        ...
        cache: LRUCache = LRUCache({{ MEMPOOL_MANAGER_LRU_CACHE }})
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        self.seen_cache_size = {{ MEMPOOL_MANAGER_LRU_CACHE }}
        self.pool = ProcessPoolExecutor({{ MEMPOOL_MANAGER_THREADS }})
        #self.pool = ProcessPoolExecutor(16)
