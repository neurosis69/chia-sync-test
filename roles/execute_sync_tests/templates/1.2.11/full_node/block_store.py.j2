...
class BlockStore:
    ...
    async def create(cls, db_wrapper: DBWrapper):
        ...
        {{ BLOCK_STORE_FULL_BLOCK_HEIGHT_INDEX }}
        ...
        {{ BLOCK_STORE_IS_FULLY_COMPACTIFIED_INDEX }}

        {{ BLOCK_STORE_HEIGHT_INDEX }}

        {{ BLOCK_STORE_HH_INDEX }} 
        {{ BLOCK_STORE_PEAK_INDEX }}
        ...
        self.block_cache = LRUCache({{ BLOCK_STORE_BLOCK_LRU_CACHE }})
        self.ses_challenge_cache = LRUCache({{ BLOCK_STORE_SES_CHALLENGE_LRU_CACHE }})
        return self
