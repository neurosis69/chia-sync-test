...
class CoinStore:
    ...
    @classmethod
    async def create(cls, db_wrapper: DBWrapper, cache_size: uint32 = uint32({{ COIN_STORE_COIN_LRU_CACHE }})):
        self = cls()
        ...
        {{ COIN_STORE_COIN_CONFIRMED_INDEX }}

        {{ COIN_STORE_COIN_SPENT_INDEX }}
        ...
        {{ COIN_STORE_COIN_PUZZLE_HASH_INDEX }}

        {{ COIN_STORE_COIN_PARENT_INDEX }}
